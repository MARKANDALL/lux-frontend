/* ============================================================================
   ...
   - Adds dedicated Word/Phoneme collapse toggle buttons (no duplicate <th>).
============================================================================ */
          ...
          <thead style="position: sticky; top: 0; z-index: 20; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
            <tr>
              <th id="wordHeader">
                ...
                <button
                  class="lux-col-toggle"
                  type="button"
                  data-col="word"
                  aria-label="Collapse/expand Word column"
                  title="Collapse/expand Word column"
                >▸</button>
              </th>
              ...
              <th id="phonemeHeader">
                ...
                <button
                  ...
                  type="button"
                  data-col="phoneme"
                  aria-label="Collapse/expand Phoneme column"
                  title="Collapse/expand Phoneme column"
                >▸</button>
              </th>
            </tr>
          </thead>
