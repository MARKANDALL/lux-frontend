...
export function createAttemptDetailModalShell() {
  ...
  function close() {
    if (!mounted) {
      ...
      try { modal.remove(); } catch (err) { globalThis.warnSwallow("features/progress/attempt-detail/modal-shell.js", err, "important"); }
      return;
    }
    ...
    try {
      unlockBodyScroll();
    } catch (err) { globalThis.warnSwallow("features/progress/attempt-detail/modal-shell.js", err, "important"); }
  }
