...
> 2. **Duplicate & Fighting Code Audit Report (2026-02-26)** — a code-level audit of duplicate and "fighting code" risks across `lux-frontend` + `luxury-language-api`.
>
> Both documents have been preserved in full. The April 2026 product audit is the primary narrative (Parts 1–9). The February 2026 code audit is preserved verbatim as a technical appendix (Part 10). Nothing has been deleted; content has only been reorganized and cross-linked where the two overlap.
>
...
> **Status notice on the code-audit appendix (Part 10):** Part 10 is a historical audit baseline, not a live unresolved-bugs list. Several findings there describe issues that were real at the February 2026 audit but have since been reduced, migrated, or fully resolved in later hardening passes. Always treat the "updated status / resolution" notes and the current architecture docs as higher priority than older finding prose. In particular, do **not** reopen the already-verified 4-file bus-first migration family unless new evidence shows a real regression.

---

## Table of Contents

**Part A — Page-by-Page Product Audit (April 2026)**
...
**Part B — Code-Level Audit Appendix (February 2026)**

10. [Duplicate & Fighting Code Audit Report](#part-10-duplicate--fighting-code-audit-report)
...
**1J.3 — Permanent "View Library" button:** *(shipped 2026-04-10)*
...
**1J.7 — Always show View Library + word count badge:** *(shipped 2026-04-10)*
...
**1K.1 — Make My Progress squares collapsible:** *(next up per 2026-04-10 session close — dashboard-template.js lines ~119–138)*
...
# Part 10: Duplicate & Fighting Code Audit Report
